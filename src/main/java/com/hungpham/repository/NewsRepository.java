...
public interface NewsRepository extends JpaRepository<NewsEntity,String> {
    ...
    @Query(nativeQuery = true, value="SELECT n.id, n.title, n.img_new, n.short_description, n.author, n.created_date, n.updated_date, c.is_main_topic \n" +
            "FROM newspaper n JOIN category c ON n.category = c.id \n" +
